...
link!("kernel32" "system" fn GetConsoleMode(hconsolehandle : HANDLE, lpmode : *mut CONSOLE_MODE) -> BOOL);
...
link!("kernel32" "system" fn ReadConsoleInputW(hconsoleinput : HANDLE, lpbuffer : *mut INPUT_RECORD, nlength : u32, lpnumberofeventsread : *mut u32) -> BOOL);
...
link!("kernel32" "system" fn SetConsoleMode(hconsolehandle : HANDLE, dwmode : CONSOLE_MODE) -> BOOL);
